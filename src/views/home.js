          ...
          <div className="home-text-section">
            ...
            <div className="home-cta-buttons">
              ...
              <Link to="/meta-ads-hub" className="home-button home-button-meta">
                <span className="home-button-icon">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                    <path d="M9.199 21.925a10.003 10.003 0 0 1-6.675-8.424c.4.358.825.688 1.273.984a9.7 9.7 0 0 0 4.602 1.715c.025.002.049.007.074.01a9.74 9.74 0 0 0 2.05-.04 9.74 9.74 0 0 0 2.051.04c.025-.003.049-.008.074-.01a9.7 9.7 0 0 0 4.602-1.715c.448-.296.874-.626 1.273-.984a10.003 10.003 0 0 1-6.675 8.424 3.06 3.06 0 0 0-2.649 0Z"/>
                    <path d="M23.498 12c0 .93-.13 1.83-.372 2.68a9.933 9.933 0 0 1-2.119 3.745c-.399.358-.825.688-1.273.984a9.7 9.7 0 0 1-4.602 1.715c-.025.002-.049.007-.074.01a9.74 9.74 0 0 1-2.05-.04 9.74 9.74 0 0 1-2.051.04c-.025-.003-.049-.008-.074-.01a9.7 9.7 0 0 1-4.602-1.715 10.11 10.11 0 0 1-1.273-.984A9.933 9.933 0 0 1 2.87 14.68 10.067 10.067 0 0 1 2.5 12c0-5.52 4.48-10 10-10s10 4.48 10 10Z"/>
                  </svg>
                </span>
                Meta Ads Hub
              </Link>
