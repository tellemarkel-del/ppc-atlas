          ...
          <div className="home-text-section">
            ...
            <div className="home-cta-buttons">
              ...
              <Link to="/meta-ads-hub" className="home-button home-button-meta">
                <span className="home-button-icon">
                  <svg width="28" height="17" viewBox="0 0 1000 600" fill="white" xmlns="http://www.w3.org/2000/svg">
                    <path d="M100 420C100 485 115 535 140 570C165 605 200 620 235 620C280 620 320 605 390 520C450 450 520 360 575 290L670 155C720 85 770 30 840 30C900 30 960 60 1000 120C960 180 920 230 875 275C830 320 780 355 780 355C780 355 778 345 775 335C770 315 760 295 745 280C730 260 710 250 690 250C665 250 645 265 620 305C605 330 590 360 575 390C560 420 545 445 525 465C500 490 470 485 450 485C380 485 325 435 325 340C325 290 335 245 355 210C375 420 100 420 100 420Z"/>
                    <path d="M260 60C310 10 370 -10 430 -10C465 -10 500 0 535 20C575 45 615 85 655 145L670 170C705 230 725 265 745 290C770 325 790 340 815 340C845 340 860 320 860 290C860 265 850 240 835 220L1000 120C1020 155 1030 200 1030 250C1030 330 1000 390 950 425C935 435 920 440 900 440C870 440 845 430 820 410C795 390 775 365 750 330L720 285C700 250 680 225 665 210C650 195 630 185 610 185C585 185 565 200 545 230C535 250 530 275 530 295C530 315 535 335 545 355L520 405C510 380 505 350 505 320C505 260 520 200 545 155L260 60Z"/>
                  </svg>
                </span>
                Meta Ads Atlas
              </Link>
