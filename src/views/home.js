              ...
              <Link to="/meta-ads-hub" className="home-button home-button-meta">
                <span className="home-button-icon">
                  <svg viewBox="0 0 512 512" width="20" height="20" fill="white">
                    <path d="M443.5 162.5c0-75.7-61.5-137.2-137.2-137.2S169.1 86.8 169.1 162.5c0 28.8 8.9 55.6 24.1 77.7-1.5 4.9-2.8 10-3.9 15.2-4.8-3.6-9.9-6.8-15.3-9.5-15.2-22.1-24.1-48.9-24.1-77.7C149.9 75.8 218.7 7 306.3 7s156.4 68.8 156.4 156.4c0 28.8-8.9 55.6-24.1 77.7-5.4 2.7-10.5 5.9-15.3 9.5-1.1-5.2-2.4-10.3-3.9-15.2 15.2-22.1 24.1-48.9 24.1-77.7z"/>
                    <path d="M68.5 349.5c0 75.7 61.5 137.2 137.2 137.2s137.2-61.5 137.2-137.2c0-28.8-8.9-55.6-24.1-77.7 1.5-4.9 2.8-10 3.9-15.2 4.8 3.6 9.9 6.8 15.3 9.5 15.2 22.1 24.1 48.9 24.1 77.7 0 86.5-68.8 156.4-156.4 156.4S49.3 436.1 49.3 349.5c0-28.8 8.9-55.6 24.1-77.7 5.4-2.7 10.5-5.9 15.3-9.5 1.1 5.2 2.4 10.3 3.9 15.2-15.2 22.1-24.1 48.9-24.1 77.7z"/>
                  </svg>
                </span>
                Meta Ads Atlas
              </Link>
